...
use App\Http\Resources\ServiceRequest\ServiceRequestDetailsCollection;
...
//    }
    ...
    public function show($id){
        $job_card = ServiceRequestDetails::find($id);
        return new ServiceRequestDetailsCollection($job_card);
    }
